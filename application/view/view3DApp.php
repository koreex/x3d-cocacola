...
<body>
	...
	<?php
		...
		//echo $model6 ."<br>";
	?>
	<p>If you are seeing the test data above Model 3d Image Data, then your bacic MVC is working</p>
</body>
</html>
-->
